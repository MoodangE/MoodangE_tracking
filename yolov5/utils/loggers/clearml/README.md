...
# this version on another customDataset version, so no duplicate files are uploaded!
...
if RANK in {-1, 0}:
    ...
    if loggers.clearml:
        ...
        # Data_dict is either None is user did not choose for ClearML customDataset or is filled in by ClearML
