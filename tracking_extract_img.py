...
def scene_boxes_data_img(img, bbox,  categories=None, names=None, offset=(0, 0), location=None):
    ...
    for i, box in enumerate(bbox):
        ...
        color = compute_color_for_labels(x1)
...
def run(
        ...
        project='inference_extract_img',  # save results to project/name
    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(dets_to_sort) > 0:
                ...
                scene_boxes_data_img(im0, bbox_xyxy, categories, names, location=predict_location)
...
def parse_opt():
    ...
    parser.add_argument('--project', default='inference_extract_img', help='save results to project/name')
